...
class Preference {
  static FlutterSecureStorage? prefsStorage = sl();
  ...
  static setSecuredString(String key, String? value) async {
    await prefsStorage!.write(key: key, value: value);
  }

  static Future<String?> getSecuredString(String key) async =>
      await prefsStorage!.read(key: key);

  static deleteSecuredString(String key) async {
    await prefsStorage!.delete(key: key);
  }

  static clearSecuredString() async {
    await prefsStorage!.deleteAll();
  }
}
